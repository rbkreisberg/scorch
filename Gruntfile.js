...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        connect: {
            ...
            proxies: [
                {
                    context : "/variant_summary",
                    host : "glados1",  //config this or proxy won't work
                    port : 3555, //config this or proxy won't work
                    https : false,
                    changeOrigin : false
                },
                {
                    context : "/seqpeek_data",
                    host : "glados1",  //config this or proxy won't work
                    port : 3555, //config this or proxy won't work
                    https : false,
                    changeOrigin : false
            ...
            dist: {
                files: [{
                    ...
                    src: [
                        ...
                        'fonts/{,*/}*.*',
                        'scripts/configurations/labels.json'
                    ]
                }]
            },
            styles: {
